...
<div class="wrapper">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="{{ route('logout') }}"
                       ...
                       class="dropdown-item dropdown-footer">Log Out</a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="brand-link bg-white m-auto" onclick="window.location.href='{{route('home')}}'">
            <img src="{{ url('images/logo.png')}}" style="height: 50px; width: 150px; background: white;" class=""
                 alt="User Image">
        </div>
...
{{--                <div class="image">--}}
{{--                    <img--}}
{{--                        src="{{ (!empty(Auth::user()->image))? url('upload/user_images/'.Auth::user()->image): url('upload/noImage.jpg')}}"--}}
...
{{--                </div>--}}
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{date('Y')}} <a href="https://www.facebook.com/ysaikat">Md. Yousuf
                Hossain</a>.</strong>
        All rights reserved.
